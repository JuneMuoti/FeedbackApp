...
<body>
  <nav class="navbar navbar-expand-sm navbar-light bg-light mb-4">
    <div class="container">
      <a class="navbar-brand" href="#">Muoti Media</a>
...
<main>
  <div class="container d-flex flex-column align-items-center">
    <img src="/feedbackapp/img/logo-no-background.png" class="w-25 mb-3" alt="">
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for Muoti Media</p>
